...
#define DELETE_BUTTON 7 // Pulsador para borrar último caracter
#define SEND_BUTTON 6   // Pulsador para enviar mensaje
#define DOT_LED 2       // LED para mostrar punto durante la codificación en morse
#define LINE_LED 3      // LED para mostrar linea durante la codificación en morse
